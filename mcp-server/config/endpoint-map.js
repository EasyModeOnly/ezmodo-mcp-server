...
export const ENDPOINT_MAP = {
  ...
  'mcpDraftMilestoneWhatsNew': { route: 'mcp/v1/milestones/draft-whats-new', method: 'POST' },
  ...
  'mcpListReleaseGates': { route: 'mcp/v1/releases/gates', method: 'GET' },
  'mcpListReleaseTemplates': { route: 'mcp/v1/releases/templates', method: 'GET' },
  'mcpSaveReleaseTemplate': { route: 'mcp/v1/releases/templates', method: 'POST' },
  'mcpGetReleaseSettings': { route: 'mcp/v1/releases/settings', method: 'GET' },
  'mcpSaveReleaseSettings': { route: 'mcp/v1/releases/settings', method: 'PUT' },
